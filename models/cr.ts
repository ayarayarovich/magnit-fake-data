 ...
 * $ pg-to-ts generate -c postgresql://username:password@194.87.226.194:5432/magnit -t categories_of_goods -t company_head_offices -t countries -t distribution_centres -t expenditure_goods -t expenditure_records -t good_write_off_reasons -t goods -t goods_in_local_storages -t goods_in_reception -t invoice_goods -t invoices -t producers -t reception_of_goods -t reception_status -t sales_floor_income_goods -t sales_floor_incomes -t sales_floors -t storage_spaces -t storage_types -t store_category_changes -t store_local_storage -t stores -t subdivisions -t supply_agreement_goods -t supply_agreements -t transportation_document_goods -t transportation_documents -t trucks -s commodity_research
 *
 */
...
const producers = {
  ...
  foreignKeys: {
    id_producer_country: { table: 'countries', column: 'id_country', $type: null as unknown as Countries },
    id_contact_person: { table: 'contact_person', column: 'contact_person_id', $type: null as unknown /* contact_person */ },
  },
...
const stores = {
  tableName: 'stores',
  columns: ['id_store', 'store_name', 'id_sales_floor', 'id_local_storage', 'store_address', 'storeman_amount', 'merchandiser_amount', 'seller_amount', 'id_store_director'],
  requiredForInsert: [],
  primaryKey: 'id_store',
  foreignKeys: {
    id_sales_floor: { table: 'sales_floors', column: 'id_sales_floor', $type: null as unknown as SalesFloors },
    id_local_storage: { table: 'store_local_storage', column: 'id_local_storage', $type: null as unknown as StoreLocalStorage },
    id_store_director: { table: 'employees', column: 'employee_id', $type: null as unknown /* employees */ },
  },
